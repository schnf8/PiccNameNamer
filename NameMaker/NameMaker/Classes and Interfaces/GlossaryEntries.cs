...
namespace NameMaker
{
    // This singleton class contains a list with all glossary entries. 
...
//    // This class contains a list with all glossary entries. 
//    public static class GlossaryEntries
//    {

//        // private static List<GlossaryEntry> glossaryList = new List<GlossaryEntry>();


//        public static List<GlossaryEntry> getEntries()
//        {
//            List<GlossaryEntry> glossaryList = new List<GlossaryEntry>();
